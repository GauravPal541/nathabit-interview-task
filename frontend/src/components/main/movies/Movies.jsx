...
import { useFavouriteMutation, useMovieQuery, useLikeMutation } from "../../../api/api";
...
function Movies() {
    ...
    const [favourite, { error: err }] = useFavouriteMutation();
    ...
    const handleFavourite = async (movieId) => {
        try {
            ...
            toast.success("Marked as favourite successfully", {
                position: "top-right",
                autoClose: 1500,
